...
public:
  ...
  AthenaArray<Real> u; // data buffer
  FaceField b; // data buffer

  // functions
  //void Initialize(int res_flag, ParameterInput *pin);
  void SetBlockSizeAndBoundaries(LogicalLocation loc, RegionSize &block_size,
                                 enum BoundaryFlag *block_bcs);
  void Mesh::AllocateAndSetBasicCoordinates(const int is,const int ie,const int js,const int je,const int ks,const int ke, LogicalLocation loc, RegionSize &block_size, enum BoundaryFlag *block_bcs);
